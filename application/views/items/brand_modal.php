          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12">
                      <?=form_open('items/create_brand')?>
                        <div class="form-group">
                          <div class="input-group">
                            <input type="text" name="name" class="form-control" placeholder="Create New Brand...">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p class="strong">Brands</p>
                      <?php foreach ($brands as $brand):?>
                          <div class="col-md-9">
                            <?=form_open('items/update_brand')?>
                              <div class="form-group">
                                <div class="input-group">
                                  <input type="text" name="name" class="form-control" name="title" value="<?=$brand['name']?>" required>
                          ...
                          <div class="col-md-3">
                            <?=form_open('items/delete_brand', array('class' => 'form-inline'))?>
