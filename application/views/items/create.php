    ...
    <body>
                                ...
                                <div class="row">       
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="itemname" name="itemname" placeholder="Enter Item Name..." value="<?php echo set_value('itemname'); ?>" required>
                                        </div>                                
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">  
                                        <div class="form-group" id="item_cost_group">
                                            <asd for="cost">Item Cost</asd>
                                            <input type="number" class="form-control" id="cost" name="cost" placeholder="Enter Item Cost..." value="<?php echo set_value('cost'); ?>" required>
                                        </div>   
                                        <div class="form-group">
        ...
        <script>
            $('#product_type').on('click',function(e){
                var value = $(this).val();
                var item_cost_group = $('#item_cost_group');
                
                if(value == 0){
                    $(item_cost_group).fadeIn('slow');
                    $(item_cost_group).children('#cost').prop('required',true);
                }else{
                    $(item_cost_group).fadeOut('slow');
                    $(item_cost_group).children('#cost').prop('required',false);
                }
            });
        </script>
    </body>
