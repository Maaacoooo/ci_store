    ...
    <section class="content">
            ...
            <tbody>
              <?php foreach ($results as $res): ?>
                <tr>
                  ...
                  <td><a href="#"><?=$res['unit']?></a></td>
                  <td><a href="#"><?=$res['brand']?></a></td>
                  <td><a href="#"><?=$res['category']?></a></td>
                  <td><a href="#"><?=$res['dp']?></a></td>                  
                  <td><em><?=ellipsize(strip_tags($res['description']), 70, 1)?></em></td>
                </tr>
              <?php endforeach; ?>
            </tbody>   
            <?php else: ?>           
      ...
      <!-- /.box -->
       ...
       <div class="box <?php if(!validation_errors())echo "collapsed-box"; else echo "box-danger";?>">
        <div class="box-header with-border">
          <h3 class="box-title">Suggest New Product</h3>
          <div class="box-tools pull-right">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?=form_open_multipart('items/suggest', array('class' => 'form-horizontal'))?>
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 col-md-6">
                <input type="text" name="serial" class="form-control" id="serial" placeholder="Serial No. " >
              </div>

              <label for="dp" class="col-sm-2 col-md-2 control-label">Dealer's Price</label>
              <div class="col-sm-10 col-md-2">
                <input type="text" name="dp" class="form-control" id="dp" placeholder="Price..." required>
              </div>
            </div>
            <div class="form-group">
