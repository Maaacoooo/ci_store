          ...
          <div class="box">
            ...
            <?=form_open('sales/update/'.$info['id'])?>
             <div class="form-group">
                ...
                <input type="text" class="form-control" disabled="" value="<?=$info['location']?>" />
              </div><!-- /.form-group -->
              <div class="form-group">
                <label for="customer">Customer</label>
                <input type="text" name="customer" id="customer" class="form-control" placeholder="Customer Name..." value="<?=$info['customer']?>" required="" />
              </div><!-- /.form-group -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="amt_tendered" id="amt_tendered" onkeyup="updateChange()" class="form-control" placeholder="Amount e.g 1000.00"  value="<?=$info['amount_tendered']?>" />
              </div><!-- /.form-group -->
